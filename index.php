...
$cates=getAllcate($db_link);
if(!($cates && is_array($cates))){
	alertMes("No category currently!!!", "http://www.google.com");
}
...
<div class="shopList comWidth clearfix">
	...
	<div class="rightArea">
		...
		<?php 
			$pros=getProsByCid($db_link, $cate['id']);
			if($pros &&is_array($pros)):
			foreach($pros as $pro):
			$proImg=getProImgById($db_link, $pro['id']);
		?>
			<div class="shop_item">
				<div class="shop_img">
		...
		<?php 
			$prosSmall=getSmallProsByCid($db_link, $cate['id']);
			if($prosSmall &&is_array($prosSmall)):
			foreach($prosSmall as $proSmall):
			$proSmallImg=getProImgById($db_link, $proSmall['id']);
		?>
